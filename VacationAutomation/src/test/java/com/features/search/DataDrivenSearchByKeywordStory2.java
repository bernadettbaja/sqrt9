...
public class DataDrivenSearchByKeywordStory2 {
    ...
    //@Issue("#WIKI-1")
    @Test
    public void searching_by_keyword_pizza_should_display_the_corresponding_article() {
        anna.is_the_home_page();
        anna.looks_for("pizza");
        anna.should_see_definition("Borrowing from Italian pizza");
    }
    @Test
